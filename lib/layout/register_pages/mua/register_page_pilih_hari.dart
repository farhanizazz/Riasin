                        ...
                        text: TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(
                                  text: '.',
                                  style:
                                  TextStyle(color: Color(0xffC55977),
                                      fontSize: 50))
                            ])),
                  ],
                ),
                ...
                currentPage == 3
                  ...
                  children: [
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () async {
                          log(_formData.kategori.isEmpty.toString());
                          if (currentPage == 0) {
                            ...
                            } else if (num.parse(_formData.jumlahOrderan) is! int) {
                              ScaffoldMessenger.of(context)
                                  .showSnackBar(SnackBar(
                                content:
                                Text('Jumlah pelanggan harus bilangan bulat'),
                                backgroundColor: Colors.red,
                                behavior: SnackBarBehavior.floating,
                              ));
                            }
                            ...
                            if (_formData.kategori.isEmpty) {
                              ...
                              try {
                                ...
                                log(e.response!.data['status'].toString());
